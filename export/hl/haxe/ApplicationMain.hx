...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("sparrow-char-editor", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("sparrow-char-editor", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "sparrow-char-editor";
		app.meta["name"] = "sparrow-char-editor";
